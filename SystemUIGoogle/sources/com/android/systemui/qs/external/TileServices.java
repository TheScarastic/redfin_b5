...
public class TileServices extends IQSService.Stub {
    ...
    public TileServices(QSTileHost qSTileHost, Looper looper, BroadcastDispatcher broadcastDispatcher, UserTracker userTracker) {
        AnonymousClass2 r0 = new BroadcastReceiver() { // from class: com.android.systemui.qs.external.TileServices.2
    ...
    public void freeService(CustomTile customTile, TileServiceManager tileServiceManager) {
        synchronized (this.mServices) {
            ...
            this.mMainHandler.post(new Runnable(customTile.getComponent().getClassName()) { // from class: com.android.systemui.qs.external.TileServices$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    TileServices.this.lambda$freeService$0(this.f$1);
                }
            });
        }
    }
