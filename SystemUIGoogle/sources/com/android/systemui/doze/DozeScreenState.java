    ...
    public void transitionTo(DozeMachine.State state, DozeMachine.State state2) {
        ...
        if (state2 == DozeMachine.State.FINISH) {
            ...
            if (hasCallbacks || z5 || z2 || z3) {
                ...
                this.mDozeHost.prepareForGentleSleep(new Runnable(screenState) { // from class: com.android.systemui.doze.DozeScreenState$$ExternalSyntheticLambda1
                    ...
                    @Override // java.lang.Runnable
                    public final void run() {
                        DozeScreenState.m90$r8$lambda$3qjB_EtpkzWDHlRw1njMF0H8(DozeScreenState.this, this.f$1);
                    }
                });
            } else {
                lambda$transitionTo$0(screenState);
