...
public class ShortcutPicker extends PreferenceFragment implements TunerService.Tunable {
    ...
    public void onCreatePreferences(Bundle bundle, String str) {
        ...
        activityList.forEach(new Consumer(context, createPreferenceScreen, preferenceCategory) { // from class: com.android.systemui.tuner.ShortcutPicker$$ExternalSyntheticLambda1
            ...
            public final void accept(Object obj) {
                ShortcutPicker.m396$r8$lambda$WAnVwRP8bHe8uwOYA7m2uuYU4Q(ShortcutPicker.this, this.f$1, this.f$2, this.f$3, (LauncherActivityInfo) obj);
            }
        });
    ...
    public /* synthetic */ void lambda$onCreatePreferences$1(Context context, PreferenceScreen preferenceScreen, PreferenceCategory preferenceCategory, LauncherActivityInfo launcherActivityInfo) {
        try {
            ...
            if (shortcuts.size() != 0) {
                ...
                shortcuts.forEach(new Consumer(context, launcherActivityInfo, preferenceScreen) { // from class: com.android.systemui.tuner.ShortcutPicker$$ExternalSyntheticLambda0
                    public final /* synthetic */ Context f$1;
                    ...
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
                        ShortcutPicker.$r8$lambda$uVFPNd33ORQiV2qfc0gfReYwDXE(ShortcutPicker.this, this.f$1, this.f$2, this.f$3, (ShortcutParser.Shortcut) obj);
                    }
                });
                return;
            }
    ...
    public void onTuningChanged(String str, String str2) {
        ...
        this.mSelectablePreferences.forEach(new Consumer(str2) { // from class: com.android.systemui.tuner.ShortcutPicker$$ExternalSyntheticLambda2
            ...
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                ShortcutPicker.$r8$lambda$TvuDAL9u832kwzwsiTZFjRh72Nc(this.f$0, (SelectablePreference) obj);
            }
        });
    }
