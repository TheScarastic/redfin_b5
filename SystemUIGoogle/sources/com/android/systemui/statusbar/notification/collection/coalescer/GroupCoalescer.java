...
public class GroupCoalescer implements Dumpable {
    ...
    private void resetShortTimeout(EventBatch eventBatch) {
        ...
        eventBatch.mCancelShortTimeout = this.mMainExecutor.executeDelayed(new Runnable(eventBatch) { // from class: com.android.systemui.statusbar.notification.collection.coalescer.GroupCoalescer$$ExternalSyntheticLambda0
            ...
            public final void run() {
                GroupCoalescer.this.lambda$resetShortTimeout$0(this.f$1);
            }
