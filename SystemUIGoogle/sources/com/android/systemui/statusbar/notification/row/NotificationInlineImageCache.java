...
public class NotificationInlineImageCache implements NotificationInlineImageResolver.ImageCache {
    ...
    @Override // com.android.systemui.statusbar.notification.row.NotificationInlineImageResolver.ImageCache
    public void purge() {
        this.mCache.entrySet().removeIf(new Predicate(this.mResolver.getWantedUriSet()) { // from class: com.android.systemui.statusbar.notification.row.NotificationInlineImageCache$$ExternalSyntheticLambda0
