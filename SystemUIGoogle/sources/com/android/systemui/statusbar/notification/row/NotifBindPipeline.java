    ...
    public void onBindRequested(NotificationEntry notificationEntry, CancellationSignal cancellationSignal, BindCallback bindCallback) {
        ...
        if (bindEntry != null) {
            ...
            if (bindCallback != null) {
                ...
                cancellationSignal.setOnCancelListener(new CancellationSignal.OnCancelListener(set, bindCallback) { // from class: com.android.systemui.statusbar.notification.row.NotifBindPipeline$$ExternalSyntheticLambda0
