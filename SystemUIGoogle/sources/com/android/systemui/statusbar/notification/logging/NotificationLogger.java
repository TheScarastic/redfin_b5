...
public class NotificationLogger implements StatusBarStateController.StateListener {
    ...
    public void logNotificationVisibilityChanges(Collection<NotificationVisibility> collection, Collection<NotificationVisibility> collection2) {
        if (!collection.isEmpty() || !collection2.isEmpty()) {
            this.mUiBgExecutor.execute(new Runnable(cloneVisibilitiesAsArr(collection), cloneVisibilitiesAsArr(collection2)) { // from class: com.android.systemui.statusbar.notification.logging.NotificationLogger$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    NotificationLogger.this.lambda$logNotificationVisibilityChanges$0(this.f$1, this.f$2);
                }
            });
        }
    }
