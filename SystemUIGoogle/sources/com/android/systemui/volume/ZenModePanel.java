...
public class ZenModePanel extends FrameLayout {
    ...
    public void setEmptyState(int i, int i2) {
        this.mEmptyIcon.post(new Runnable(i, i2) { // from class: com.android.systemui.volume.ZenModePanel$$ExternalSyntheticLambda4
            ...
            public final void run() {
                ZenModePanel.this.lambda$setEmptyState$2(this.f$1, this.f$2);
            }
        });
    }
    ...
    public void setAutoText(CharSequence charSequence) {
        this.mAutoTitle.post(new Runnable(charSequence) { // from class: com.android.systemui.volume.ZenModePanel$$ExternalSyntheticLambda5
            ...
            @Override // java.lang.Runnable
            public final void run() {
                ZenModePanel.this.lambda$setAutoText$3(this.f$1);
            }
        });
    }
    ...
    private void transitionFrom(View view, View view2) {
        view.post(new Runnable(view2, view) { // from class: com.android.systemui.volume.ZenModePanel$$ExternalSyntheticLambda3
    ...
    private static String foreverSummary(Context context) {
        return context.getString(17041662);
    }
    ...
    public void onClickTimeButton(View view, ConditionTag conditionTag, boolean z, int i) {
        ...
        if (i2 == -1) {
            ...
            for (int i4 = 0; i4 < length; i4++) {
                ...
                long j = currentTimeMillis + ((long) (60000 * i6));
