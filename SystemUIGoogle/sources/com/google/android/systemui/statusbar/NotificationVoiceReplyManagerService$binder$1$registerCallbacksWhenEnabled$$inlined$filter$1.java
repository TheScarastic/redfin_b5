...
public final class NotificationVoiceReplyManagerService$binder$1$registerCallbacksWhenEnabled$$inlined$filter$1 implements Flow<Pair<? extends Integer, ? extends Integer>> {
    ...
    public Object collect(final FlowCollector<? super Pair<? extends Integer, ? extends Integer>> flowCollector, Continuation continuation) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new FlowCollector<Pair<? extends Integer, ? extends Integer>>() { // from class: com.google.android.systemui.statusbar.NotificationVoiceReplyManagerService$binder$1$registerCallbacksWhenEnabled$$inlined$filter$1.2
            ...
            public Object emit(Pair<? extends Integer, ? extends Integer> pair, Continuation continuation2) {
                Object emit;
                return (!Boxing.boxBoolean(((Number) pair.getFirst()).intValue() == this.this$0.getUserId()).booleanValue() || (emit = flowCollector.emit(pair, continuation2)) != IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED()) ? Unit.INSTANCE : emit;
            }
        }, continuation);
