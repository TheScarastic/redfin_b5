...
public class ShapeAppearanceModel {
    ...
    public Intrinsics leftEdge;
    public Intrinsics rightEdge;
    public Intrinsics topEdge;
    ...
    public boolean isRoundRect(RectF rectF) {
        boolean z = this.leftEdge.getClass().equals(Intrinsics.class) && this.rightEdge.getClass().equals(Intrinsics.class) && this.topEdge.getClass().equals(Intrinsics.class) && this.bottomEdge.getClass().equals(Intrinsics.class);
    ...
    public static Builder builder(Context context, int i, int i2, CornerSize cornerSize) {
        ...
        try {
            ...
            CornerTreatment createCornerTreatment = R$bool.createCornerTreatment(i4);
            ...
            CornerTreatment createCornerTreatment2 = R$bool.createCornerTreatment(i5);
            ...
            CornerTreatment createCornerTreatment3 = R$bool.createCornerTreatment(i6);
            ...
            CornerTreatment createCornerTreatment4 = R$bool.createCornerTreatment(i7);
