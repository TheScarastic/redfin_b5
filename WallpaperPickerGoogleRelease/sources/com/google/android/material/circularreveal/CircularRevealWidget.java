...
public interface CircularRevealWidget {
    ...
    public static class CircularRevealEvaluator implements TypeEvaluator<RevealInfo> {
        ...
        public RevealInfo evaluate(float f, RevealInfo revealInfo, RevealInfo revealInfo2) {
            ...
            float lerp = R$id.lerp(revealInfo3.centerX, revealInfo4.centerX, f);
            float lerp2 = R$id.lerp(revealInfo3.centerY, revealInfo4.centerY, f);
            float lerp3 = R$id.lerp(revealInfo3.radius, revealInfo4.radius, f);
