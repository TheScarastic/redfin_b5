...
public class TextInputEditText extends AppCompatEditText {
    ...
    public TextInputEditText(Context context, AttributeSet attributeSet, int i) {
        ...
        ThemeEnforcement.checkCompatibleTheme(context, attributeSet, i, 2131886770);
        ThemeEnforcement.checkTextAppearance(context, attributeSet, iArr, i, 2131886770, new int[0]);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, iArr, i, 2131886770);
