...
public class VerticalWidgetRun extends WidgetRun {
    ...
    public boolean supportsWrapComputation() {
        if (this.dimensionBehavior != 3 || this.widget.mMatchConstraintDefaultHeight == 0) {
            return true;
        }
        return false;
    }
            ...
            if (dimensionDependency.readyToSolve && !dimensionDependency.resolved && this.dimensionBehavior == 3) {
                ...
                if (i2 == 2) {
                    ...
                    if (dimensionDependency3.resolved) {
                        ...
                        if (i3 == -1) {
                            f2 = (float) dimensionDependency3.value;
                ...
                if (dependencyNode2.readyToSolve) {
                    if (!dependencyNode.resolved || !dependencyNode2.resolved || !this.dimension.resolved) {
                        ...
                        if (this.dimension.resolved && this.start.targets.size() > 0 && this.end.targets.size() > 0) {
                            ...
                            dependencyNode6.resolve((int) ((((float) ((i11 - i9) - this.dimension.value)) * f4) + ((float) i9) + 0.5f));
