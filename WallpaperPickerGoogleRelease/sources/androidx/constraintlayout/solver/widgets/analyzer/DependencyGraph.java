                ...
                if ((i7 == 4 || i7 == 1 || i7 == 2) && (i8 == 4 || i8 == 1 || i8 == 2)) {
                    ...
                    if (i7 == 3 && (i8 == 2 || i8 == 1)) {
                        if (i9 == 3) {
                            ...
                            measure$enumunboxing$(next, 1, (int) ((((float) height2) * next.mDimensionRatio) + 0.5f), 1, height2);
                            next.horizontalRun.dimension.resolve(next.getWidth());
                            next.verticalRun.dimension.resolve(next.getHeight());
                            next.measured = true;
                        } else if (i9 == 1) {
                            ...
                            if (iArr2[0] == 1 || iArr2[0] == 4) {
                                measure$enumunboxing$(next, 1, (int) ((f * ((float) constraintWidgetContainer.getWidth())) + 0.5f), i8, next.getHeight());
                                next.horizontalRun.dimension.resolve(next.getWidth());
                                next.verticalRun.dimension.resolve(next.getHeight());
                                next.measured = true;
                            }
                    ...
                    if (i8 == 3 && (i7 == 2 || i7 == 1)) {
                        if (i10 == 3) {
                            ...
                            measure$enumunboxing$(next, 1, width2, 1, (int) ((((float) width2) * f3) + 0.5f));
                            next.horizontalRun.dimension.resolve(next.getWidth());
                            next.verticalRun.dimension.resolve(next.getHeight());
                            next.measured = true;
                        } else if (i10 == 1) {
                            ...
                            if (iArr3[1] == 1 || iArr3[1] == 4) {
                                measure$enumunboxing$(next, i7, next.getWidth(), 1, (int) ((f2 * ((float) constraintWidgetContainer.getHeight())) + 0.5f));
                                next.horizontalRun.dimension.resolve(next.getWidth());
                                next.verticalRun.dimension.resolve(next.getHeight());
                                next.measured = true;
                            }
                        ...
                        if (i9 == 1 || i10 == 1) {
                            ...
                            if (iArr4[0] == 1 || iArr4[0] == 1) {
                                if (iArr4[1] == 1 || iArr4[1] == 1) {
                                    measure$enumunboxing$(next, 1, (int) ((f * ((float) constraintWidgetContainer.getWidth())) + 0.5f), 1, (int) ((f2 * ((float) constraintWidgetContainer.getHeight())) + 0.5f));
                                    next.horizontalRun.dimension.resolve(next.getWidth());
                                    next.verticalRun.dimension.resolve(next.getHeight());
                                    next.measured = true;
                                }
