...
public class AppCompatActivity extends FragmentActivity implements AppCompatCallback {
    ...
    public AppCompatActivity() {
        ...
        AnonymousClass2 r0 = new OnContextAvailableListener() { // from class: androidx.appcompat.app.AppCompatActivity.2
        ...
        if (contextAwareHelper.mContext != null) {
            r0.onContextAvailable(contextAwareHelper.mContext);
        }
        contextAwareHelper.mListeners.add(r0);
    }
