...
public class FastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    ...
    public FastScroller(RecyclerView recyclerView, StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2, int i, int i2, int i3) {
        ...
        AnonymousClass2 r0 = new RecyclerView.OnScrollListener() { // from class: androidx.recyclerview.widget.FastScroller.2
            ...
            public void onScrolled(RecyclerView recyclerView2, int i4, int i5) {
                ...
                boolean z = computeHorizontalScrollRange - i7 > 0 && i7 >= fastScroller.mScrollbarMinimumRange;
        ...
        if (recyclerView2 != recyclerView) {
            if (recyclerView2 != null) {
                ...
                this.mRecyclerView.removeOnScrollListener(r0);
                cancelHide();
            }
