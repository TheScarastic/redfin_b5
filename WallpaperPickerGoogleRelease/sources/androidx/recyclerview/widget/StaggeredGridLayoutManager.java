...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public final int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (true) {
            ...
            if (!((i12 < 0 || i12 >= state.getItemCount()) ? z3 : true) || (!this.mLayoutState.mInfinite && this.mRemainingSpans.isEmpty())) {
                break;
            }
            ...
            if (this.mOrientation == 1) {
                int i17 = this.mSizePerSpan;
                int i18 = this.mWidthMode;
                int i19 = ((ViewGroup.MarginLayoutParams) layoutParams).width;
                int i20 = z ? 1 : 0;
                int i21 = z ? 1 : 0;
                int i22 = z ? 1 : 0;
                measureChildWithDecorationsAndMargin(view, RecyclerView.LayoutManager.getChildMeasureSpec(i17, i18, i20, i19, z), RecyclerView.LayoutManager.getChildMeasureSpec(this.mHeight, this.mHeightMode, getPaddingBottom() + getPaddingTop(), ((ViewGroup.MarginLayoutParams) layoutParams).height, true), z);
            } else {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:234:0x040c, code lost:
        if (checkForGaps() != false) goto L_0x0410;
     */
