...
public class ExifInterface {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:65:0x0190, code lost:
        return;
     */
    /* JADX WARNING: Removed duplicated region for block: B:33:0x00b3 A[FALL_THROUGH] */
     ...
     */
    /* JADX WARNING: Removed duplicated region for block: B:114:0x0143 A[RETURN] */
    /* JADX WARNING: Removed duplicated region for block: B:115:0x0146  */
    /* JADX WARNING: Removed duplicated region for block: B:146:0x018f  */
    /* JADX WARNING: Removed duplicated region for block: B:153:0x0111 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /* JADX WARNING: Removed duplicated region for block: B:93:0x010f A[RETURN] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
                ...
                if (byteOrderedDataInputStream.read(bArr2) == 4) {
                    ...
                    if (!Arrays.equals(bArr2, PNG_CHUNK_TYPE_IEND)) {
                        if (Arrays.equals(bArr2, PNG_CHUNK_TYPE_EXIF)) {
                            ...
                            throw new IOException("Failed to read given length for given PNG chunk type: " + R$attr.byteArrayToHexString(bArr2));
                        }
                        int i3 = readInt + 4;
            ...
            try {
                ...
                if (byteOrderedDataInputStream.read(bArr) == 4) {
                    ...
                    if (Arrays.equals(WEBP_CHUNK_TYPE_EXIF, bArr)) {
                        ...
                        throw new IOException("Failed to read given length for given PNG chunk type: " + R$attr.byteArrayToHexString(bArr));
                    }
                    if (readInt2 % 2 == 1) {
                        readInt2++;
                    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:120:0x028f  */
    ...
    public static class ExifAttribute {
        ...
        /*  JADX ERROR: JadxRuntimeException in pass: SSATransform
            jadx.core.utils.exceptions.JadxRuntimeException: Not initialized variable reg: 3, insn: 0x019b: MOVE  (r2 I:??[OBJECT, ARRAY]) = (r3 I:??[OBJECT, ARRAY]), block:B:137:0x019b
